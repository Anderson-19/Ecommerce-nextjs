    ...
    return (
        <div>
            ...
            <nav
                className={
                    clsx(
                        "fixed p-5 right-0 top-0 w-[500px] md:w-[400px] h-screen bg-white z-20 shadow-2xl transform transition-all duration-300",
                        {
                    ...
                    isAuthenticated && (
                        <>
                            ...
                            <Link 
                                href="/auth/login"
                                onClick={() => {
                                    productsInCart.map( product => removeProductFromCart(product) );
                                    setAddress({
                                        firstName: '',
                                        lastName: '',
                                        address: '',
